<template>
  <div class="jumbotron">
    ...
    <p class="lead">
      This is a simple fancy user management application that is created with
      Spring Boot, MySQL and Vue JS.
    </p>
    <hr class="my-4" />
    <p>
...
export default {
  ...
  methods: {
    ...
    changeRole() {
      ...
      UserService.changeRole(this.user.username, newRole).then((response) => {
        const u = this.user;
